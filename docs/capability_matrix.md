...
| N8 | WF-03 JD 匹配 | Embedding 主路径 | 智谱 embedding-3 为主（千帆 V2 备）；证据验证器已启用 | 已验证 | 2026-08-06 | tests/embedding_full_recall_zhipu-3.json（2000 对召回 91.0%，th=0.50）+ tests/integration_recall_zhipu_embedding_3.json（10 对召回 83.8%/精确率 96.9%/F1 90.0%，证据归档 deliverables/p0-03-evidence/） |
