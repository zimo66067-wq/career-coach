...
from repositories.database import delete_session_data  # noqa: E402
from providers import model as model_provider  # noqa: E402
...
def main():
    ...
    # Phase 5：模型工厂只有一个归属地（providers.model），api 与服务层都从它取
